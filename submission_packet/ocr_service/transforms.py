# Image -> tensor helpers shared by training and inference.
...
def to_tensor(pil):
    # grayscale PIL -> float tensor in [-1, 1], shape [1, H, W]
...
def fit_line(pil, h=LINE_H, w=LINE_W):
    # scale line crop to target height, pad right on a white canvas
    pil = pil.convert("L")
